...
Расчёт приблизительный. Обратите внимание, для принятия реальных решений измените данные в файлах, так как они очень неточны.
...
## Запуск
Просто запустите программу, если вы под Windows (vatacalculator.exe). Под остальными ОС см. справку по .NET Core
...
### Подпапки
В папке data вы можете создать подпапку с нужным вам наименованием. Затем, при расчёте, нужно будет ввести имя этой подпапки для того, чтобы можно было выбрать файлы именно из этой подпапки.
