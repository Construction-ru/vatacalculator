    ...
    class Program
    {
        ...
        class CalculationData
        {
            ...
            public void SetValuesFromConsole()
            {
                ...
                Console.WriteLine("Например, термическое сопротивление для 375 мм газобетона теплопроводностью L=0,147: 0,375/0,147=2,551. 2,551*1000=2551, значит нужно ввести 2551");
